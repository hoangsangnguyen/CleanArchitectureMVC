(function () {
    ...
    AuthenticationService.$inject = ['$http', '$window', '$rootScope', '$timeout', 'UserService', 'AppConstants', '$log'];
    function AuthenticationService($http, $window, $rootScope, $timeout, UserService, AppConstants, $log) {
        var service = {};
