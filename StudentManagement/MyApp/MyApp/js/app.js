...
//(function () {
//    "use strict";
let constants = import('./config/app.constants.js');
let appConfig = import('./config/app.config.js');
let appRun = import('./config/app.run.js');
...
var module = angular.module('helloApp', requires);

module.constant('AppConstants', constants);

module.config(function () { appConfig });
